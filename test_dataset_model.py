...
for dataset in opt.datasets:
	...
	if(opt.dataset_mode=='2afc'):
		(score, results_verbose) = stlpips.score_2afc_dataset(data_loader, trainer.forward, name=dataset)
	elif(opt.dataset_mode=='jnd'):
		(score, results_verbose) = stlpips.score_jnd_dataset(data_loader, trainer.forward, name=dataset)
